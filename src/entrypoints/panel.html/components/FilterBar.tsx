    ...
    <div className="flex flex-wrap items-center gap-2 px-3 py-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#252526]">
      ...
      <div className="relative flex-shrink-0">
        <input
          ...
          className="w-48 px-2 py-1 text-xs rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:outline-none focus:border-blue-500"
        />
        {filters.searchQuery && (
          <button
